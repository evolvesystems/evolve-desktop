...
echo "🔍 Monitoring GitHub Actions build for evolve-desktop v1.0.7..."
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
...
windows_job = None
for job in jobs:
    if 'windows' in job.get('name', '').lower():
        windows_job = job
        break
...
for artifact in artifacts:
    ...
    if 'windows' in name.lower() or 'msi' in name.lower():
        url = artifact.get('archive_download_url', '')
        print(f'Found: {name}')
        print(f'Download URL: {url}')
        print(f'Size: {artifact.get(\"size_in_bytes\", 0) / 1024 / 1024:.2f} MB')
        print()
"
            echo ""
            echo "You can download all artifacts from:"
